        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="vistas/Principal.jsp"><i class="fas fa-home"></i> Principal</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="vistas/torneo.jsp"><i class="fa-solid fa-gamepad"></i> Torneo</a>
                    </li> 
                    <li class="nav-item active">
                        <a class="nav-link" href="./Controlador?accion=Nuevo"><i class="fa-brands fa-shopify"></i> Tienda<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="form-group">
                            <div class="card">
                                ...
                                <div class="card-body text-center d-flex">
                                    ...
                                    <img src="${p.getImagen()}" width="170" height="170">
                                </div>
